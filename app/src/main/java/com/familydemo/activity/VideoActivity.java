...
import com.familydemo.view.RippleImageView;
...
public class VideoActivity extends BaseActivity implements View.OnClickListener {
    ...
    private LinearLayout introduce_ll, time_ll, record_ll;
    private RelativeLayout progress_ll;
    private Chronometer timer;
    private TextView state_tv, again_tv;
    private ImageView play_iv, ensure_iv;
    private RippleImageView record_iv;
    ...
    private void initView() {
        ...
        introduce_ll = findViewById(R.id.introduce_ll);
        ...
        again_tv = findViewById(R.id.again_tv);
        record_iv = findViewById(R.id.record_iv);
        play_iv = findViewById(R.id.play_iv);
        ensure_iv = findViewById(R.id.ensure_iv);
    ...
    private void initDate() {
        ...
        ensure_iv.setOnClickListener(this);
